...
--
-- Name: session_todo_status; Type: TYPE; Schema: kb; Owner: -
--

CREATE TYPE kb.session_todo_status AS ENUM (
    'draft',
    'pending',
    'in_progress',
    'completed',
...
--
-- Name: acp_run_events; Type: TABLE; Schema: kb; Owner: -
--
...
--
-- Name: acp_sessions; Type: TABLE; Schema: kb; Owner: -
--
...
--
-- Name: database_backups; Type: TABLE; Schema: kb; Owner: -
--
...
CREATE TABLE kb.discovery_jobs (
    ...
    config jsonb DEFAULT '{}'::jsonb NOT NULL,
    kb_purpose text DEFAULT ''::text NOT NULL,
...
CREATE TABLE kb.discovery_type_candidates (
    ...
    refinement_iteration integer DEFAULT 1 NOT NULL,
    merged_from uuid[],
...
--
-- Name: embedding_cache; Type: TABLE; Schema: kb; Owner: -
--
...
CREATE TABLE kb.object_extraction_jobs (
    ...
    error_details jsonb,
    staging_branch_id uuid,
    created_object_ids uuid[] DEFAULT '{}'::uuid[] NOT NULL
);


--
-- Name: COLUMN object_extraction_jobs.staging_branch_id; Type: COMMENT; Schema: kb; Owner: -
--

COMMENT ON COLUMN kb.object_extraction_jobs.staging_branch_id IS 'Staging branch where extracted objects land pending review. NULL = legacy (objects on main) or no branch isolation.';
...
--
-- Name: org_model_config; Type: TABLE; Schema: kb; Owner: -
--

CREATE TABLE kb.org_model_config (
    org_id uuid NOT NULL,
    generative_model text DEFAULT ''::text NOT NULL,
...
--
-- Name: project_edge_schema_registry; Type: TABLE; Schema: kb; Owner: -
--
...
--
-- Name: project_journal; Type: TABLE; Schema: kb; Owner: -
--
...
--
-- Name: project_journal_notes; Type: TABLE; Schema: kb; Owner: -
--
...
--
-- Name: project_model_config; Type: TABLE; Schema: kb; Owner: -
--
...
--
-- Name: schema_migration_jobs; Type: TABLE; Schema: kb; Owner: -
--
...
--
-- Name: schema_migration_runs; Type: TABLE; Schema: kb; Owner: -
--
...
--
-- Name: TABLE schema_migration_runs; Type: COMMENT; Schema: kb; Owner: -
--

COMMENT ON TABLE kb.schema_migration_runs IS 'Tracks all schema migration runs with statistics and outcomes';
...
--
-- Name: session_todos; Type: TABLE; Schema: kb; Owner: -
--
...
CREATE TABLE kb.session_todos (
    ...
    session_id uuid NOT NULL,
    content text NOT NULL,
    status kb.session_todo_status DEFAULT 'draft'::kb.session_todo_status NOT NULL,
    author text,
...
--
-- Name: TABLE skills; Type: COMMENT; Schema: kb; Owner: -
--
...
--
-- Name: COLUMN skills.name; Type: COMMENT; Schema: kb; Owner: -
--
...
--
-- Name: COLUMN skills.description_embedding; Type: COMMENT; Schema: kb; Owner: -
--
...
--
-- Name: COLUMN skills.project_id; Type: COMMENT; Schema: kb; Owner: -
--
...
--
-- Name: COLUMN skills.org_id; Type: COMMENT; Schema: kb; Owner: -
--
...
--
-- Name: acp_run_events acp_run_events_pkey; Type: CONSTRAINT; Schema: kb; Owner: -
--
...
--
-- Name: acp_sessions acp_sessions_pkey; Type: CONSTRAINT; Schema: kb; Owner: -
--
...
--
-- Name: database_backups database_backups_pkey; Type: CONSTRAINT; Schema: kb; Owner: -
--
...
--
-- Name: embedding_cache embedding_cache_pkey; Type: CONSTRAINT; Schema: kb; Owner: -
--

ALTER TABLE ONLY kb.embedding_cache
    ADD CONSTRAINT embedding_cache_pkey PRIMARY KEY (cache_key);
...
--
-- Name: org_model_config org_model_config_pkey; Type: CONSTRAINT; Schema: kb; Owner: -
--

ALTER TABLE ONLY kb.org_model_config
    ADD CONSTRAINT org_model_config_pkey PRIMARY KEY (org_id);
...
--
-- Name: project_journal_notes project_journal_notes_pkey; Type: CONSTRAINT; Schema: kb; Owner: -
--
...
--
-- Name: project_journal project_journal_pkey; Type: CONSTRAINT; Schema: kb; Owner: -
--
...
--
-- Name: project_model_config project_model_config_pkey; Type: CONSTRAINT; Schema: kb; Owner: -
--

ALTER TABLE ONLY kb.project_model_config
    ADD CONSTRAINT project_model_config_pkey PRIMARY KEY (project_id);
...
--
-- Name: project_schemas project_schemas_project_id_schema_id_key; Type: CONSTRAINT; Schema: kb; Owner: -
--
...
--
-- Name: schema_migration_jobs schema_migration_jobs_pkey; Type: CONSTRAINT; Schema: kb; Owner: -
--
...
--
-- Name: schema_migration_runs schema_migration_runs_pkey; Type: CONSTRAINT; Schema: kb; Owner: -
--
...
--
-- Name: session_todos session_todos_pkey; Type: CONSTRAINT; Schema: kb; Owner: -
--

ALTER TABLE ONLY kb.session_todos
    ADD CONSTRAINT session_todos_pkey PRIMARY KEY (id);
...
--
-- Name: idx_acp_sessions_is_archived; Type: INDEX; Schema: kb; Owner: -
--

CREATE INDEX idx_acp_sessions_is_archived ON kb.acp_sessions USING btree (project_id, is_archived);


--
-- Name: idx_acp_sessions_project_id; Type: INDEX; Schema: kb; Owner: -
--
...
--
-- Name: idx_agent_runs_acp_session_id; Type: INDEX; Schema: kb; Owner: -
--
...
--
-- Name: idx_agents_consecutive_failures; Type: INDEX; Schema: kb; Owner: -
--
...
CREATE INDEX idx_chat_conversations_acp_session_id ON kb.chat_conversations USING btree (acp_session_id) WHERE (acp_session_id IS NOT NULL);
...
--
-- Name: idx_database_backups_created_at; Type: INDEX; Schema: kb; Owner: -
--
...
--
-- Name: idx_database_backups_status; Type: INDEX; Schema: kb; Owner: -
--
...
--
-- Name: idx_discovery_jobs_project_id; Type: INDEX; Schema: kb; Owner: -
--

CREATE INDEX idx_discovery_jobs_project_id ON kb.discovery_jobs USING btree (project_id);
...
--
-- Name: idx_discovery_type_candidates_job_id; Type: INDEX; Schema: kb; Owner: -
--

CREATE INDEX idx_discovery_type_candidates_job_id ON kb.discovery_type_candidates USING btree (job_id);
...
--
-- Name: idx_embedding_policies_is_system; Type: INDEX; Schema: kb; Owner: -
--
...
--
-- Name: idx_graph_object_revision_counts_unique; Type: INDEX; Schema: kb; Owner: -
--
...
--
-- Name: idx_graph_objects_namespace; Type: INDEX; Schema: kb; Owner: -
--

CREATE INDEX idx_graph_objects_namespace ON kb.graph_objects USING btree (project_id, namespace) WHERE (namespace IS NOT NULL);
...
--
-- Name: idx_graph_objects_upsert_namespace; Type: INDEX; Schema: kb; Owner: -
--

CREATE UNIQUE INDEX idx_graph_objects_upsert_namespace ON kb.graph_objects USING btree (project_id, namespace, type, key) WHERE ((key IS NOT NULL) AND (namespace IS NOT NULL) AND (supersedes_id IS NULL) AND (deleted_at IS NULL) AND (branch_id IS NULL));
...
--
-- Name: idx_graph_schemas_project_id; Type: INDEX; Schema: kb; Owner: -
--
...
--
-- Name: idx_llm_usage_events_user; Type: INDEX; Schema: kb; Owner: -
--

CREATE INDEX idx_llm_usage_events_user ON kb.llm_usage_events USING btree (user_id, created_at);
...
--
-- Name: idx_migration_runs_project; Type: INDEX; Schema: kb; Owner: -
--
...
--
-- Name: idx_migration_runs_started; Type: INDEX; Schema: kb; Owner: -
--
...
--
-- Name: idx_migration_runs_status; Type: INDEX; Schema: kb; Owner: -
--
...
CREATE INDEX idx_project_edge_schema_registry_project_id ON kb.project_edge_schema_registry USING btree (project_id);


--
-- Name: idx_project_edge_schema_registry_schema_id; Type: INDEX; Schema: kb; Owner: -
--

CREATE INDEX idx_project_edge_schema_registry_schema_id ON kb.project_edge_schema_registry USING btree (schema_id);


--
-- Name: idx_project_edge_schema_registry_unique; Type: INDEX; Schema: kb; Owner: -
--

CREATE UNIQUE INDEX idx_project_edge_schema_registry_unique ON kb.project_edge_schema_registry USING btree (project_id, schema_id, type_name);


--
-- Name: idx_project_journal_branch; Type: INDEX; Schema: kb; Owner: -
--
...
--
-- Name: idx_project_journal_notes_journal; Type: INDEX; Schema: kb; Owner: -
--
...
--
-- Name: idx_project_journal_project_created; Type: INDEX; Schema: kb; Owner: -
--
...
--
-- Name: idx_schema_migration_jobs_project_id; Type: INDEX; Schema: kb; Owner: -
--
...
--
-- Name: idx_schema_migration_jobs_status; Type: INDEX; Schema: kb; Owner: -
--
...
--
-- Name: idx_session_todos_session_id; Type: INDEX; Schema: kb; Owner: -
--

CREATE INDEX idx_session_todos_session_id ON kb.session_todos USING btree (session_id);


--
-- Name: idx_session_todos_status; Type: INDEX; Schema: kb; Owner: -
--

CREATE INDEX idx_session_todos_status ON kb.session_todos USING btree (status);
...
--
-- Name: acp_run_events acp_run_events_run_id_fkey; Type: FK CONSTRAINT; Schema: kb; Owner: -
--
...
--
-- Name: acp_sessions acp_sessions_project_id_fkey; Type: FK CONSTRAINT; Schema: kb; Owner: -
--
...
--
-- Name: agent_runs agent_runs_acp_session_id_fkey; Type: FK CONSTRAINT; Schema: kb; Owner: -
--
...
--
-- Name: agent_runs agent_runs_agent_definition_id_fkey; Type: FK CONSTRAINT; Schema: kb; Owner: -
--
...
--
-- Name: agents agents_agent_definition_id_fkey; Type: FK CONSTRAINT; Schema: kb; Owner: -
--
...
ALTER TABLE ONLY kb.chat_conversations
    ADD CONSTRAINT chat_conversations_acp_session_id_fkey FOREIGN KEY (acp_session_id) REFERENCES kb.acp_sessions(id) ON DELETE SET NULL;
...
--
-- Name: graph_embedding_jobs fk_graph_embedding_jobs_object_id; Type: FK CONSTRAINT; Schema: kb; Owner: -
--

ALTER TABLE ONLY kb.graph_embedding_jobs
    ADD CONSTRAINT fk_graph_embedding_jobs_object_id FOREIGN KEY (object_id) REFERENCES kb.graph_objects(id) ON DELETE CASCADE;
...
--
-- Name: llm_usage_events llm_usage_events_user_id_fkey; Type: FK CONSTRAINT; Schema: kb; Owner: -
--

ALTER TABLE ONLY kb.llm_usage_events
    ADD CONSTRAINT llm_usage_events_user_id_fkey FOREIGN KEY (user_id) REFERENCES core.user_profiles(id) ON DELETE SET NULL;
...
--
-- Name: object_extraction_jobs object_extraction_jobs_staging_branch_id_fkey; Type: FK CONSTRAINT; Schema: kb; Owner: -
--

ALTER TABLE ONLY kb.object_extraction_jobs
    ADD CONSTRAINT object_extraction_jobs_staging_branch_id_fkey FOREIGN KEY (staging_branch_id) REFERENCES kb.branches(id) ON DELETE SET NULL;


--
-- Name: org_model_config org_model_config_org_id_fkey; Type: FK CONSTRAINT; Schema: kb; Owner: -
--

ALTER TABLE ONLY kb.org_model_config
    ADD CONSTRAINT org_model_config_org_id_fkey FOREIGN KEY (org_id) REFERENCES kb.orgs(id) ON DELETE CASCADE;
...
ALTER TABLE ONLY kb.project_edge_schema_registry
    ADD CONSTRAINT project_edge_schema_registry_project_id_fkey FOREIGN KEY (project_id) REFERENCES kb.projects(id) ON DELETE CASCADE;


--
-- Name: project_edge_schema_registry project_edge_schema_registry_schema_id_fkey; Type: FK CONSTRAINT; Schema: kb; Owner: -
--

ALTER TABLE ONLY kb.project_edge_schema_registry
    ADD CONSTRAINT project_edge_schema_registry_schema_id_fkey FOREIGN KEY (schema_id) REFERENCES kb.graph_schemas(id) ON DELETE CASCADE;


--
-- Name: project_journal_notes project_journal_notes_journal_id_fkey; Type: FK CONSTRAINT; Schema: kb; Owner: -
--
...
--
-- Name: project_model_config project_model_config_project_id_fkey; Type: FK CONSTRAINT; Schema: kb; Owner: -
--

ALTER TABLE ONLY kb.project_model_config
    ADD CONSTRAINT project_model_config_project_id_fkey FOREIGN KEY (project_id) REFERENCES kb.projects(id) ON DELETE CASCADE;
...
--
-- Name: project_edge_schema_registry; Type: ROW SECURITY; Schema: kb; Owner: -
--

ALTER TABLE kb.project_edge_schema_registry ENABLE ROW LEVEL SECURITY;

--
-- Name: project_edge_schema_registry project_edge_schema_registry_delete; Type: POLICY; Schema: kb; Owner: -
--

CREATE POLICY project_edge_schema_registry_delete ON kb.project_edge_schema_registry FOR DELETE USING (((COALESCE(current_setting('app.current_project_id'::text, true), ''::text) = ''::text) OR ((project_id)::text = current_setting('app.current_project_id'::text, true))));


--
-- Name: project_edge_schema_registry project_edge_schema_registry_insert; Type: POLICY; Schema: kb; Owner: -
--

CREATE POLICY project_edge_schema_registry_insert ON kb.project_edge_schema_registry FOR INSERT WITH CHECK (((COALESCE(current_setting('app.current_project_id'::text, true), ''::text) = ''::text) OR ((project_id)::text = current_setting('app.current_project_id'::text, true))));


--
-- Name: project_edge_schema_registry project_edge_schema_registry_select; Type: POLICY; Schema: kb; Owner: -
--

CREATE POLICY project_edge_schema_registry_select ON kb.project_edge_schema_registry FOR SELECT USING (((COALESCE(current_setting('app.current_project_id'::text, true), ''::text) = ''::text) OR ((project_id)::text = current_setting('app.current_project_id'::text, true))));


--
-- Name: project_edge_schema_registry project_edge_schema_registry_update; Type: POLICY; Schema: kb; Owner: -
--
