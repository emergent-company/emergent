...
func (ap *AutoProvisioner) LinkToRun(ctx context.Context, workspace *AgentSandbox, runID string) error {
...
func (ap *AutoProvisioner) GetProviderForWorkspace(ws *AgentSandbox) (Provider, error) {
	if ws == nil {
