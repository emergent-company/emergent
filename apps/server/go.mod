...
require (
	...
	github.com/emergent-company/emergent.memory/apps/server/pkg/sdk v0.24.0
...
replace github.com/emergent-company/emergent.memory/apps/server/pkg/sdk => ./pkg/sdk
