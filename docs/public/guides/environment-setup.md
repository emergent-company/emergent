...
category: guides
tags: [environment, setup, docker, development, production, deployment]
description: Comprehensive guide for setting up Local, Dev, Staging, and Production environments
lastUpdated: 2025-02-11
readTime: 45
related: [template-pack-creation]
---
...
This starts three services managed by the workspace CLI:
...
- Services run in background via PID-based process manager
...
**Option B: Using workspace CLI with environment override**

```bash
npm run workspace:start -- --env dev
```
...
- Check logs via deployment platform or workspace CLI
